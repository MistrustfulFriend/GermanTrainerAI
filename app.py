        ...
        <div className="bg-white rounded-lg shadow-lg p-8">
          ...
          <div className="space-y-4">
            <div className="border-2 border-blue-200 rounded-lg p-6 hover:border-blue-400 transition-colors cursor-pointer"
                 onClick={() => startPractice('flipcard')}>
              ...
              <div className="mt-4 space-y-2">
                <button 
                  onClick={(e) => { e.stopPropagation(); startPractice('flipcard', 'english'); }}
                  className="w-full bg-blue-500 text-white py-2 px-4 rounded hover:bg-blue-600 transition-colors text-sm">
                  🇬🇧 Practice German → English
                </button>
                <button 
                  onClick={(e) => { e.stopPropagation(); startPractice('flipcard', 'russian'); }}
                  className="w-full bg-blue-500 text-white py-2 px-4 rounded hover:bg-blue-600 transition-colors text-sm">
                  🇷🇺 Practice German → Russian
                </button>
              </div>
            </div>

            <div className="border-2 border-green-200 rounded-lg p-6 hover:border-green-400 transition-colors cursor-pointer"
              ...
              <div className="mt-4 space-y-2">
                <button 
                  onClick={(e) => { e.stopPropagation(); startPractice('quiz', 'english'); }}
                  className="w-full bg-green-500 text-white py-2 px-4 rounded hover:bg-green-600 transition-colors text-sm">
                  🇬🇧 Quiz: German → English
                </button>
                <button 
                  onClick={(e) => { e.stopPropagation(); startPractice('quiz', 'russian'); }}
                  className="w-full bg-green-500 text-white py-2 px-4 rounded hover:bg-green-600 transition-colors text-sm">
                  🇷🇺 Quiz: German → Russian
                </button>
              </div>
        ...
        <div className="bg-white rounded-lg shadow-lg p-6">
          ...
          <div className="mb-6 text-center">
            <span className="bg-blue-100 text-blue-800 px-4 py-1 rounded-full text-sm font-medium">
              {targetLanguage === 'english' ? '🇬🇧 German → English' : '🇷🇺 German → Russian'}
            </span>
          </div>
      ...
      <div className="max-w-2xl mx-auto p-6">
        <div className="bg-white rounded-lg shadow-lg p-6">
          ...
          <div className="flex justify-end">
            ...
            >
              {currentIndex === practiceWords.length - 1 ? 'Finish' : 'Next Question'}
              <ChevronRight className="w-5 h-5 ml-1" />
            </button>
          </div>
